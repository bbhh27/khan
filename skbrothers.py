...
"""
Copyright (c) 2006-2022 sqlmap developers (https://www.facebook.com/groups/1126228364780841/?ref=share)
...
try:
    ...
    try:
        ...
        sys.exit("[!] wrong installation detected (missing modules). Visit 'facebook public group sk brothers/#installation' for further details")
